...
GET_StudentSectionAnalytics: async (
  ...
  GET_StudentAssessmentAnalytics: async (
     studentId:string
      ...
      const response = await GET(`${analyticsRead}/Analytics/GetStudentAssessmentProgress?studentNumber=${studentId}`);
      return response;
    },
    GET_StudentQuizAnalytics: async (
      studentId:string
        ...
        const response = await GET(`${analyticsRead}/Analytics/GetStudentQuizProgress?studentNumber=${studentId}`);
        return response;
      },
