...
const TableBody: NextPage<{ list: any[] }> = ({ list }) => {
        ...
        {list &&
          list.map((data: any, key) => (
            <tr key={key} className="selected">
             <td style={{width: "200px" }} className="text-center mx-auto text-justify js-lists-values-projects small">
  ...
  <p className="text-justify">{data}</p>
              ...
              <i onClick={(prev) => setPlayPause(!prev)} id="playPauseIcon" className="material-icons mr-8pt">
