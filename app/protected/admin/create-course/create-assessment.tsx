...
import { ICourse, ISection, IVideo } from "@/app/interfaces/courses";
import {
  addChoices,
  createQuestion,
  createQuizDetail,
...
import { addAssessmentQuestion, addChoicesToQuestion, deleteAssessmentQuestion, getSelectedAssessmentForEdit, updateAssessmentQuestion, updateChoiceDetails } from "@/app/redux/assessmentSlice";
...
export const CreateCourseAssessmentModal: React.FC<CreateCourseAssessmentModal> = ({
  onClose,
}) => {
  ...
  const [expandedVideo, setExpandedVideo] = useState<string>("1")
 ...
 const _courseFromState: ICourse = useSelector(getSelectedCourseForEdit).course;
  ...
  console.log("Quiz",_quizzesFromState)
 ...
 //UseEffect Hooks
  useEffect(() => {
    ...
    if (assessmentQuestions?.length > 0) {
      const lastQuestionId = assessmentQuestions?.map((question) => question.id);
                    ...
                    <li className="list-group-item d-flex">
                      ...
                      <div className="flex d-flex flex-column">
                        ...
                        <div className="card-subtitle text-70 paragraph-max mb-16pt">
                          ...
                          {
                            questions[questionNumber - 1].questionType === 0 &&   <div>
                            <a
                              onClick={() =>
...
{choices?.length > 0 && choices?.map((option: IChoice, index: any) => (
      ...
      />
                        ...
                        {isQuestionCreated && (questionType === "0" || questionType === "1") && (
                          <div>
                            <button
                              onClick={newQuestion}
                              style={{
