        ...
        <div className="js-fix-footer footer border-top-2">
          <div className="container-fluid page__container page-section d-flex flex-column">
            <p className="text-70 brand mb-24pt">
              <img className="brand-icon" src="assets/images/logo/black-70@2x.png" width={30} alt="Thooto" /> Thooto
            </p>
            <p className="measure-lead-max text-muted mb-0 small">Thooto is a beautifully crafted user interface for modern Business Admin Web Applications, with examples for many pages needed for Customer Relationship Management, Enterprise Resource Planning, Thooto Resources, Content Management System, Project Management, Tasks, eCommerce, Messaging and Account Management.</p>
          </div>
            ...
            <div className="sidebar-account mx-16pt mb-16pt dropdown">
              ...
              <div className="dropdown-menu dropdown-menu-full dropdown-menu-caret-center">
                ...
                <a className="dropdown-item d-flex align-items-center">
                  ...
                  <small className="ml-4pt flex">
                    <span className="d-flex flex-column">
                      <strong className="text-black-100">Thooto Inc.</strong>
