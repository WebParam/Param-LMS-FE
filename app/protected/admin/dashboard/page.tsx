        ...
        <div className="container page__container page-section">
          ...
          <div className="card card-body mb-32pt">
            ...
            <div className="chart" style={{ height: 320 }}>
              ...
              <canvas
                id="earningsChart"
                className="chart-canvas js-update-chart-bar chartjs-render-monitor"
                data-chart-legend="#legend"
                data-chart-line-background-color="gradient:primary,gray"
                data-chart-prefix="$"
                data-chart-suffix="k"
                style={{ display: "block", width: 854, height: 320 }}
                width={854}
                height={320}
              />
            </div>
              ...
              <div className="tab-pane" id="sm_layouts">
                ...
                <ul className="sidebar-menu">
                  <li className="sidebar-menu-item">
                    <a
                      className="sidebar-menu-button"
                      href="../Compact_App_Layout/instructor-dashboard.html"
                    >
                  ...
                  <li className="sidebar-menu-item">
                    <a
                      className="sidebar-menu-button"
                      href="../Mini_App_Layout/instructor-dashboard.html"
                    >
                  ...
                  <li className="sidebar-menu-item active">
                    <a
                      className="sidebar-menu-button"
                      href="../Mini_Secondary_Layout/instructor-dashboard.html"
                    >
                      <span className="sidebar-menu-text">
                        Mini + Secondary
                      </span>
                  ...
                  <li className="sidebar-menu-item">
                    <a
                      className="sidebar-menu-button"
                      href="../App_Layout/instructor-dashboard.html"
                    >
                  ...
                  <li className="sidebar-menu-item">
                    <a
                      className="sidebar-menu-button"
                      href="../Boxed_App_Layout/instructor-dashboard.html"
                    >
                  ...
                  <li className="sidebar-menu-item">
                    <a
                      className="sidebar-menu-button"
                      href="../Sticky_App_Layout/instructor-dashboard.html"
                    >
                  ...
                  <li className="sidebar-menu-item">
                    <a
                      className="sidebar-menu-button"
                      href="../Fixed_Layout/instructor-dashboard.html"
                    >
