...
export default function ({
  ...
  const [facilitatorGrades, setFacilitatorGrades] = useState<number[]>([
    5, 3, 4,
          ...
          <tr>
            <td className="py-2 d-flex justify-content-between">
              ...
              <div className="d-flex flex-row justify-content-between mr-5">
                ...
                <h6 style={{ color: "green" }} className="mr-3 ">
                  Moderator
                </h6>
              </div>
            </td>
            ...
            {rubric.map((choice, index) => (
              ...
              >
                <div className="d-flex flex-column align-items-start">
                  <div style={{ color: "green" }} className=" d-flex mt-2">
                    {Array.from({ length: moderatorGrades[index] || 0 }).map(
                      (_, i) => (
                ...
                <td
                  style={{ width: "200px" }}
                  className="py-1 d-flex flex-row justify-content-between w-25 "
                >
                  <div className="w-50">
                    <GradeInput
                      isFacilitator
      ...
      <div className="d-flex w-75">
        <div
          ...
          className={`text-center w-100 py-2 ${
            grade < questionScore * 0.5 && "text-danger"
          }`}
        >
