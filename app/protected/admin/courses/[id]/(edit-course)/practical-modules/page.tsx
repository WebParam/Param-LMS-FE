"use client";
import Module from "@/components/course/[id]/practical-modules/Module";
    ...
    <>
      ...
      {currentItems.length > 0 ? (
        currentItems.map((data) => {
          const url =
            arrUrl.join("/") +
            `/practical-modules/${data.id}/knowledge-topics?title=${title}&moduleTitle=${data.title}`;
        ...
        <div className="card my-24pt text-center py-3">
          No Practical Modules Available...
        </div>
      )}
