...
export default function CommentDetails() {
  ...
  const handlePostNewComment = async () => {
    if (comment) {
      const reply: IComment = {
        ...
        }'s comment on the ${new Date().toUTCString()}`,
        message: newComment ?? "",
      ...
      var response: IResponseObject<IComment> = await Api.POST_AddCommentReply(
        CommentReply
      );
      debugger;
  ...
  useEffect(() => {
    var _comment: IComment =
      JSON.parse(localStorage.getItem("comment") as any) || null;
            ...
            <div className="mb-24pt mb-sm-0 mr-sm-24pt">
              ...
              <ol className="breadcrumb p-0 m-0">
                <li className="breadcrumb-item">
                  <a href="/protected/student/course/all-courses">Home</a>
                </li>
          ...
          <div className="row">
            <div className="col-md-8">
              ...
              <p className="text-muted d-flex align-items-center mb-lg-32pt">
                <a
                  href="/protected/student/Comments/all-comments"
                  className="mr-3"
                >
                  Back to Community
                </a>
                <a href="#" className="mr-2 text-50">
                  Mute
                </a>
                <a href="#" className="mr-2 text-50">
                  Report
              ...
              <div className="card card-body">
                <div className="d-flex">
                  <a
                    href=""
                    className="avatar avatar-32pt avatar-online mr-12pt"
                  >
                    ...
                    <span className="avatar-title rounded-circle">
                      {getInitials(comment?.creatingUserName ?? "")}
                    </span>
                  </a>
                  <div className="flex">
                    <p className="d-flex align-items-center mb-2">
                      <a href="" className="text-body mr-2">
                        <strong>{comment?.creatingUserName}</strong>
                      </a>
                      {comment && (
                        <small className="text-muted">
                          {formatTimeDifference(comment.createdDate)}
                        </small>
                      )}
                    </p>
                    <p>{comment?.message}</p>
                    ...
                    <div className="d-flex align-items-center">
                      <a
                        href=""
                        className="text-50 d-flex align-items-center text-decoration-0"
                      >
                        <i
                      ...
                      <a
                        href=""
                        className="text-50 d-flex align-items-center text-decoration-0 ml-3"
                      >
                        <i
                          className="material-icons mr-1"
                          style={{ fontSize: "inherit" }}
                          ...
                          <div className="d-flex align-items-center">
                            <div>
                              <a href="" className="text-body">
                                <strong>{reply.creatingUserName}</strong>
                              </a>
                              <br />
                              <small className="ml-auto text-muted">
                                {formatTimeDifference(reply.createdDate)}
                              </small>
                            </div>
                            <a className="ml-auto">
                              {" "}
            ...
            <div className="col-md-4">
              ...
              <p className="text-70 mb-24pt">
                People who started the most discussions on Huma.
              </p>
              <div className="mb-4">
                {topCommenters?.map((commenter) => (
                  <div className="d-flex align-items-center mb-2">
                    <a href="" className="avatar avatar-xs mr-8pt">
                      ...
                      <span className="avatar-title rounded-circle">
                        {getInitials(commenter[0])}
                      </span>
                    </a>
                    <a href="" className="flex mr-2 text-body">
                      <strong>{commenter[0]}</strong>
                    </a>
                    <span className="text-70 mr-2">{commenter[1]}</span>
                    <i className="text-muted material-icons font-size-16pt">
                      forum
                    </i>
                  </div>
                ))}
