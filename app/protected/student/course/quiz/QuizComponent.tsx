...
export default function QuizData() {
  ...
  const [viewResults, setViewResults] = useState<boolean>(true)
  ...
  useEffect(() => {
    ...
    const updateDuration = () => {
      ...
      const timeDifference = Math.floor((currentTime - quizStartTime) / 1000);
                ...
                <div className="d-flex align-items-center flex-nowrap">
                  <div className="mr-16pt">
                    <a href="student-take-course.html">
                      <img src="../../public/images/paths/angular_64x64.png" width={40} alt="Angular" className="rounded" />
                    </a>
                  </div>
                  <div className="flex">
                    <a href="student-take-course.html" className="card-title text-body mb-0">
