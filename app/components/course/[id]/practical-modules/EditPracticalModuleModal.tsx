...
function EditPracticalModuleModal(props: any) {
    ...
    >
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Edit Practical Module</Modal.Title>
        </Modal.Header>
...
export default dynamic(() => Promise.resolve(EditPracticalModuleModal), {
  ssr: false,
});
