"use client";
import Table from "../../../course/[id]/course-applicants/graphs/(components)/Table";
...
import { socioEconomicStatusData } from "../../../course/[id]/course-applicants/graphs/StudentSocioEcoStatus/data";
  ...
  return (
    <>
      ...
      <div className="row card-group-row">
        <div data-aos="slide-up" className="col-lg-6 w-100 col-md-12 card-group-row__col">
