...
import EditBtn from "../course/[id]/knowledge-modules/Buttons";
import WorkBookQuestionOptions from "./WorkBookQuestionOptions";
import WorkBookQuestionRubrics from "./WorkBookQuestionRubrics";


export default function WorkAddBookQuestions({ question }: { question: IQuestion }) {
    ...
    <form ref={ref} action={updateQuestionWithParams}>
      <div className="row">
        <div className="card p-4 col-11">
          ...
          <div className="mt-4">
            {questionType == "Quiz" ? (
              <WorkBookQuestionOptions options={options} />
            ) : (
              <WorkBookQuestionRubrics rubric={rubrics[0]} />
            )}
          </div>
        </div>
        <div
