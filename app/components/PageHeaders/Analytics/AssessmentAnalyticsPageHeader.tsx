        ...
        <div className="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
          <div className="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
            <div className="mb-24pt mb-sm-0 mr-sm-24pt">
              <h2 className="mb-0">
                {
                    isStudent ? <span>{studentName}</span> : `Assessment Analytics - ${title}`
                }
               </h2>
              ...
              <ol className="breadcrumb p-0 m-0">
                ...
                <li className="breadcrumb-item active">Assessment Analytics</li>
              </ol>
            </div>
          </div>
          {isStudent && (
            <button onClick={() => router.back()} className="btn btn-success">Assessment Analytics</button>
          )}
           {
